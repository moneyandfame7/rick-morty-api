...
export class AuthorizationException {
  ...
  public incorrectVerificationLink(): HttpException {
    return this.apiErrorService.throwDemo(HttpStatus.BAD_REQUEST, HttpStack.INVALID_LINK, 'Invalid verification link')
  }

  public alreadyVerified(): HttpException {
    return this.apiErrorService.throwDemo(HttpStatus.BAD_REQUEST, HttpStack.ALREADY_VERIFIED, 'Already verified')
  }
