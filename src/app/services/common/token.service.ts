...
export class TokenService {
    ...
    public constructor(private readonly tokenRepository: TokenRepository, private readonly jwtService: JwtService, private readonly authorizationException: AuthorizationException, private readonly config: EnvironmentConfigService) {
