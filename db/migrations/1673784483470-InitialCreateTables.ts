...
export class InitialCreateTables1673784483470 implements MigrationInterface {
    name = 'InitialCreateTables1673784483470'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "episodes" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "type" character varying NOT NULL, "episode" character varying NOT NULL, "air_date" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_6a003fda8b0473fffc39cb831c7" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "characters" ADD CONSTRAINT "FK_7610db29b50cbd4ce26e85a8653" FOREIGN KEY ("LocationId") REFERENCES "locations"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "characters" ADD CONSTRAINT "FK_673177c51778bce5af0e02b45bf" FOREIGN KEY ("OriginId") REFERENCES "locations"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "characters" DROP CONSTRAINT "FK_673177c51778bce5af0e02b45bf"`);
        await queryRunner.query(`ALTER TABLE "characters" DROP CONSTRAINT "FK_7610db29b50cbd4ce26e85a8653"`);
