...
export class InitialCreateTables1675881669397 implements MigrationInterface {
    name = 'InitialCreateTables1675881669397'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "users" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "username" character varying NOT NULL, "email" character varying NOT NULL, "password" character varying, "banned" boolean NOT NULL DEFAULT false, "banReason" character varying, "auth_type" character varying NOT NULL, "roleId" integer, CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email"), CONSTRAINT "UQ_e752aee509d8f8118c6e5b1d8cc" UNIQUE ("email", "id"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
