...
export class InitialCreateTables1676114064255 implements MigrationInterface {
    name = 'InitialCreateTables1676114064255'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "users" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "username" character varying NOT NULL, "email" character varying NOT NULL, "password" character varying, "banned" boolean NOT NULL DEFAULT false, "banReason" character varying, "auth_type" character varying NOT NULL, "photo" character varying, "roleId" integer, CONSTRAINT "UQ_fe0bb3f6520ee0469504521e710" UNIQUE ("username"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
